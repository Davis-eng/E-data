...
public  class MainActivity extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        inputDialog.setIcon(R.drawable.data);
        inputDialog.setTitle("D-Capture");
        inputDialog.setMessage("New Data Title");
        ...
        inputDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(MainActivity.this.getApplicationContext(), "New Data List Successfully Created", 0).show();
            }
        });
        inputDialog.setNegativeButton("NO", new android.content.DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
        ...
        listDialog.setTitle("Select Captured List");
        listDialog.setIcon(R.drawable.tick);
        //listDialog.setMessage("Select Captured List");
        ...
        TextView textView = (TextView) findViewById(R.id.microhub);
        // Capture text clicks
